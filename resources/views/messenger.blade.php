...
<head>
    ...
    @vite(['resources/css/app.css', 'resources/js/messages.js'])
...
<script>
    ...
    let user_avatar = '{{auth()->user()->avatar_url}}';
    let user_image = '{{auth()->user()->image_url}}';
...
{{--    var pusher = new Pusher('4f21bb790d7d040b5660', {--}}
{{--        cluster: 'eu',--}}
