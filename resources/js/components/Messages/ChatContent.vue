            ...
            <div class="py-6 py-lg-12" id="chat-body">
                <div v-for="message in $root.messages" v-bind:key="message.id" class="message" :class="{'message-out': message.user_id == $root.userId}">
                    <a href="#" data-bs-toggle="modal" data-bs-target="#modal-profile" class="avatar avatar-responsive">
                        <img v-if="message.user.image_url" v-bind:src="message.user.image_url" alt="..." class="avatar-img rounded-circle"  style="width: 100%; height: 100%; object-fit: cover;">
                        <img v-else v-bind:src="message.user.avatar_url" alt="..." class="avatar-img rounded-circle" style="width: 100%; height: 100%; object-fit: cover;">
                    </a>
